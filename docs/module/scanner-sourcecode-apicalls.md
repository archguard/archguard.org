...
layout: default
parent: Modules
title:  "服务地图（feat_apicalls）"
permalink: /modules/scanner/sourcecode-apicalls
nav_order: 3
---
...
API 分析主要是在 Scanner（<https://github.com/archguard/archguard>）的 `analyser_sourcecode/feat_apicalls` 模块中，主要代码文件：
